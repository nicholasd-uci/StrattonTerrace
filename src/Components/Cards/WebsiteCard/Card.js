    ...
    return (
        ...
        <div className="cards__container">
            <div className="card">
                ...
                <li>Stock Images: Included</li>
                <li><b>1 </b> Contact/Query Form</li>
                <li> Completed Within 48 to 72 hrs </li>
                       <li 
              style={{
                fontSize: '10px',
                paddingBottom: '5px'
            ...
            <a href="facetime:16578779300" target="_blank" rel="noreferrer"  className="card__button_call">CALL US</a>
                ...
                <div className="card__content">
                    <div className="card__data">
                         <h1 className="card__title">Complete Deploy Website</h1>
                         <span className="card__price">$1,300.00</span>
                <ul>
                <li><b>6 Pages</b> Complete Front-End & Back-End</li>
                <li><b>$50</b> additional per page</li>
            ...
            <a href="facetime:16578779300" target="_blank" rel="noreferrer"  className="card__button_call">CALL US</a>
                ...
                <div className="card__content">
                    <div className="card__data">
                         <h1 className="card__title">Wix Editor-X Website</h1>
                         <span className="card__price">$1,750.00</span>
                <ul>
                <li><b>8 Pages</b> Complete Front-End & Back-End</li>
                <li><b>$50</b> additional per page</li>
                <li>Advance Site SEO</li>
                <li>Google My Business</li>
                <li>Google Analytics</li>
                <li>Plug-In Installation</li>
                <li>Complete Site Walk-Through </li>
                <li 
              style={{
                fontSize: '10px',
                paddingBottom: '5px'
            ...
            <a href="facetime:16578779300" target="_blank" rel="noreferrer"  className="card__button_call">CALL US</a>
                ...
                <div className="card__content">
                    <div className="card__data">
                         <h1 className="card__title">WordPress Website</h1>
                         <span className="card__price">$1,850.00</span>
                <ul>
                <li><b>8 Pages</b> Complete Front-End & Back-End</li>
                <li><b>$50</b> additional per page</li>
                <li>Advance Site SEO</li>
            ...
            <a href="facetime:16578779300" target="_blank" rel="noreferrer"  className="card__button_call">CALL US</a>
                ...
                <div className="card__content">
                    <div className="card__data">
                         <h1 className="card__title">React Website</h1>
                         <span className="card__price">$4,499.00</span>
                <ul>
                <li><b>10 Pages</b> Complete Front-End & Back-End</li>
                <li><b>$150</b> additional per page</li>
                <li>1-Year Free Hosting</li>
                <li>Company DataBase </li>
                <li>Site SEO</li>
                <li>Complete Secured Deployed Guarantee</li>
                <li 
              style={{
                fontSize: '10px',
                paddingBottom: '5px'
