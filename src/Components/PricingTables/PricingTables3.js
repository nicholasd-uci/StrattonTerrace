...
export default class PricingTables3 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
      ...
      <PricingTable  highlightColor='rgb(216, 188, 32)'>
          <PricingSlot  onClick={this.submit} buttonText='ORDER' title='Personal Landing Page' priceText='$249'>
          ...
          <PricingSlot  onClick={this.submit} buttonText='ORDER' title='Professional Landing Page' priceText='$600'>
          ...
          <PricingSlot highlighted onClick={this.submit} buttonText='ORDER' title='Athlete Recruiting Page' priceText='$2,000'>
