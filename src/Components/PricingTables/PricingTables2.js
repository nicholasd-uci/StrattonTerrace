...
import { Container } from 'reactstrap';
    ...
    export default class PricingTables2 extends React.Component {
      ...
      <PricingTable  highlightColor='rgb(216, 188, 32)'>
          <PricingSlot  onClick={this.submit} buttonText='ORDER' title='Elite Web Pack' priceText='$450'>
          ...
          <PricingSlot  onClick={this.submit} buttonText='ORDER' title='Corporate Web pack' priceText='$1,550'>
          ...
          <PricingSlot highlighted onClick={this.submit} buttonText='ORDER' title='Business Web Pack' priceText='$2,450'>
